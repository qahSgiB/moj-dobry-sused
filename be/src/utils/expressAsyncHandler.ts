...
const expressAsyncHandler = <P, ResBody, ReqBody, ReqQuery, Locals extends Record<string, unknown>>(handler: RequestHandler<P, ResBody, ReqBody, ReqQuery, Locals>): RequestHandler<P, ResBody, ReqBody, ReqQuery, Locals> => {
